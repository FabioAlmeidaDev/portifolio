...
export const Home = (props:any) => {
    return(
        <div className="main with-bkg" id="introduction">
            <Introduction name="Fabio Almeida" message="a full stack software engineer"/>
            <div className="main-container container-fluid">
                <Education id="what_i_know" className="anchor"/>
                
                <SectionTitle label="Here's my technical background"/>
                <div className="flex-container inline-flex center">
                    ...
                    <TechTile src="./logos/vuejs.png" label="VueJS" rating={5}/>
                    <TechTile src="./logos/react.png" label="ReactJS" rating={4}/>
                    <TechTile src="./logos/nodejs.png" label="NodeJS" rating={5}/>

                    <TechTile src="./logos/java.png" label="Java" rating={3}/>
                ...
                <div className="flex-container inline-flex center">
                    <TechTile src="./logos/graphql.png" label="GraphQL" size="small"/>
               ...
               <SectionTitle label="My career timeline in a snapshot" id="timeline"/>
                <img src="./timeline-3.png" className="col-sm-8 col-xs-12 center-horizontally"/>
                <div className="col-sm-8 col-xs-12 center-horizontally timeline">
                    ...
                    <p>In <b>2020</b> I joined Fidelity Investiments as a Principal Software Engineer, to work on their front end development team, in <b>2021</b> I transfered into a DevOps role to help cement the infra-structure and tech stack used by Fidelity's front end engineers.</p>
                    <p>In <b>2022</b> I was assigned as a techinical lead to a Healthcare claims project, in <b>2023</b> I changed teams remaining in the technical lead role and leading the Healthcare claims for web project.</p>
                </div>
